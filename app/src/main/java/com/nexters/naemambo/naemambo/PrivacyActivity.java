...
public class PrivacyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String content="<p><b><font color='#333333'>제 1조 개인 정보 수집ㆍ이용목적</font></b></p> \n" +
                ...
                "                - 회원의 서비스 신청 시 유선 상담을 위해 지정된 업체에게 이에 필요한 회원의 정보를 알려주는 경우<br> \n" +
                "                - 서비스관련 정보제공 및 부가서비스 정보제공에 대한 메일전송에 해당하는 경우<br> \n" +
                "                - 홈페이지 제작상담 및 계약지원을 위해 내부규정에 의해 견적서를 제출한 업체에게 제공하는 경우<br> \n" +
